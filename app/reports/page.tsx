    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-12">
        <div className="max-w-lg mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-center text-gray-900">Generate Custom Report</h2>
      ...
      <div className="container py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Generate and manage custom reports</p>
        </div>
      </div>
