    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm border-b">
        <div className="container py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900">{siteData?.settings?.appName || 'Analytics Pro Dashboard'}</h1>
      ...
      <div className="container py-8">
        <div className="card p-8 max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-sm">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">Main dashboard with key metrics and insights</p>
          <div className="mt-6">
      ...
      <div className="container py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Main dashboard with key metrics and insights</p>
        </div>
      </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-16">
        <div className="container text-center">
          <p>&copy; 2024 {siteData?.settings?.appName || 'Analytics Pro Dashboard'}. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
